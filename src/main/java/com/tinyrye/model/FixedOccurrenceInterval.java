...
import com.tinyrye.serialization.FixedOccurrenceIntervalJsonDeserializer;
import com.tinyrye.serialization.NamedType;

@NamedType("fixedInterval")
@JsonDeserialize(using=FixedOccurrenceIntervalJsonDeserializer.class)
public class FixedOccurrenceInterval implements OccurrenceSchedule
{
    ...
    public FixedOccurrenceInterval id(Integer id) { this.id = id; return this; }
    public FixedOccurrenceInterval startsAt(OffsetDateTime startsAt) { this.startsAt = startsAt; return this; }
    public FixedOccurrenceInterval endsAt(OffsetDateTime endsAt) { this.endsAt = endsAt; return this; }
    public FixedOccurrenceInterval magnitude(Integer magnitude) { this.magnitude = magnitude; return this; }
    public FixedOccurrenceInterval unit(ChronoUnit unit) { this.unit = unit; return this; }
    ...
    @Override
    public Iterator<OffsetDateTime> occurrences(OffsetDateTime referenceStart) {
        return null;
    }
    ...
    public boolean equals(Object that) {
        ...
        else if (that instanceof FixedOccurrenceInterval) return equals((FixedOccurrenceInterval) that);
        else return false;
    }
    ...
    public String toString() {
        ...
        return new ObjectPrinter().printObjectProperties("fixedOccurrenceInterval", properties);
    }

    public boolean equals(FixedOccurrenceInterval that) {
